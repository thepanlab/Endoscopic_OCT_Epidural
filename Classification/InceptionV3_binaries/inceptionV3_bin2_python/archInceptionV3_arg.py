...
with open('/gpfs/alpine/bif121/proj-shared/epidural/epidural_data/a_images_1D.npy', 'rb') as f:
    a_images_1D = np.load(f)
    
with open('/gpfs/alpine/bif121/proj-shared/epidural/epidural_data/a_label.npy', 'rb') as f:
    a_label = np.load(f)

with open('/gpfs/alpine/bif121/proj-shared/epidural/epidural_data/a_epidural_num.npy', 'rb') as f:
...
for index in a_selected_epidural_test:
    ...
    bool_epidural_num = a_epidural_num_bin_ligament_flavum != index
    a_images_1D_7_epidurals = a_images_1D_bin_ligament_flavum[bool_epidural_num]
    a_label_num_7_epidurals = a_label_num_bin_ligament_flavum[bool_epidural_num]
    a_epidural_num_7_epidurals =a_epidural_num_bin_ligament_flavum[bool_epidural_num]
    ...
    for index_val in a_epidural_num_val:
        ...
        model_xception.save("/gpfs/alpine/bif121/proj-shared/epidural/epidural_results/archInceptionV3_bin2_results/model_outer_K%s_outer_k%s_val.h5"%(index, index_val))

        print( "Elapsed time during the whole program in seconds for K%s_outer_k%s_val: "%(index, index_val), time_lapse)
        
        with open('/gpfs/alpine/bif121/proj-shared/epidural/epidural_results/archInceptionV3_bin2_results/time_total_K%s_outer_k%s_val.npy'%(index, index_val), 'wb') as f:
        ...
        with open('/gpfs/alpine/bif121/proj-shared/epidural/epidural_results/archInceptionV3_bin2_results/pred_val_K%s_outer_k%s_val.npy'%(index, index_val), 'wb') as f:
            np.save(f, y_proba)
        
        with open('/gpfs/alpine/bif121/proj-shared/epidural/epidural_results/archInceptionV3_bin2_results/history_K%s_outer_k%s_val.pickle'%(index, index_val), 'wb') as handle:
