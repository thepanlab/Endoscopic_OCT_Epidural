...
for index in a_selected_epidural_test:
    ...
    for index_val in a_epidural_num_val:
        ...
        model_xception.save("/gpfs/alpine/bif121/proj-shared/epidural/epidural_results/archXception_bin2_results/model_outer_K%s_outer_k%s_val.h5"%(index, index_val))

        print( "Elapsed time during the whole program in seconds for K%s_outer_k%s_val: "%(index, index_val), time_lapse)
        
        with open('/gpfs/alpine/bif121/proj-shared/epidural/epidural_results/archXception_bin2_results/time_total_K%s_outer_k%s_val.npy'%(index, index_val), 'wb') as f:
        ...
        with open('/gpfs/alpine/bif121/proj-shared/epidural/epidural_results/archXception_bin2_results/pred_val_K%s_outer_k%s_val.npy'%(index, index_val), 'wb') as f:
            np.save(f, y_proba)
        
        with open('/gpfs/alpine/bif121/proj-shared/epidural/epidural_results/archXception_bin2_results/history_K%s_outer_k%s_val.pickle'%(index, index_val), 'wb') as handle:
